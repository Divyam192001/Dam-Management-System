...
?>
	...
	<div class="span2">
          <div class="well sidebar-nav">
              ...
              <li class="active"><a href="user.php"><i class="icon-dashboard icon-2x"></i> Dashboard </a></li> 
...
<li><a href="usercontrol.php"><i class="icon-group icon-2x"></i>Water Control</a>         </li>
	...
	<div class="contentheader">
			...
			<font style=" font:bold 44px 'Aleo'; color:#722290;"><center>Model User</center></font>
<div id="mainmain">


                   
<a href="userstate.php"><i class="icon-group icon-2x"></i><br> States</a>     
  
<a href="userdam.php"><i class="icon-group icon-2x"></i><br> DAMs</a> 
<a href="usercontrol.php"><i class="icon-group icon-2x"></i><br> Water Control</a> 
